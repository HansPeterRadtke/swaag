...
REQUIRED_PAYLOAD_KEYS: dict[str, frozenset[str]] = {
    ...
    "failure_classification_fallback": frozenset({"error", "error_type", "classification"}),
    ...
    "model_response_chunk": frozenset({"kind", "prompt_mode", "attempt", "elapsed_seconds", "chunk_index", "content_chars", "content_preview", "stop"}),
