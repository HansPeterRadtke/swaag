...
CASES = (
    AttachmentContextCase(
        ...
        attachment_bytes=b"Unrelated archived material.\n",
        original_name="unrelated.txt",
    ...
    AttachmentContextCase(
        ...
        attachment_bytes=_sequential_attachment().encode("utf-8"),
        original_name="sequential-evidence.txt",
        media_type="text/plain",
        chunk_chars=256,
    ...
    AttachmentContextCase(
        ...
        attachment_bytes=_partial_attachment().encode("utf-8"),
        original_name="partial-evidence.txt",
        media_type="text/plain",
        chunk_chars=256,
    ...
    AttachmentContextCase(
        ...
        attachment_bytes=_overflow_attachment().encode("utf-8"),
        original_name="overflow-evidence.txt",
        media_type="text/plain",
        chunk_chars=100_000,
