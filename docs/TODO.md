...
- [x] **Store raw tool results durably and semantically project oversized current-turn observations under measured context pressure.** Raw canonical events remain authoritative and prompt projections retain exact source references. Extend targeted retrieval to older archived results.
