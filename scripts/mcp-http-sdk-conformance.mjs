...
const [sdkRoot, endpoint, workspaceRoot] = process.argv.slice(2);
if (!sdkRoot || !endpoint || !workspaceRoot) {
  throw new Error(
    "usage: mcp-http-sdk-conformance.mjs SDK_ROOT ENDPOINT WORKSPACE_ROOT",
  );
}
